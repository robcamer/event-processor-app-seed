...
This service is part of the Network Observability starter template to perform network packet analysis and reporting.  This service ingests a sample event file to provide metadata for report generation. It is a coral application seed designed to run on the athena-control-plane software factory.
